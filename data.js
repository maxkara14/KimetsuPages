    ...
    extensions: [
        {
            ...
            description: "Центр управления визуальными модулями для чата. Позволяет в один клик включать интерфейсы планшета с пуш-уведомлениями, радио-виджеты, кинематографичные рамки для сцен и очищать ответы нейросети от технического мусора.",
