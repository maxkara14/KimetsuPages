const siteData = {
    ...
    bots: [
        ...
        {
            title: "Лиза ✨",
            description: "Лиза Воронина — восемнадцатилетняя элитная гимнастка и отличница московского лицея с двойной жизнью: безупречная дочь днем и магнитичная королева закрытых рейвов ночью. Подходит для социальных игр, манипуляций, роскоши, риска, опасного флирта и историй о бунте золотой молодежи.",
            icon: "spark",
